        ...
        @if($students)
            @foreach($students as $student)
                ...
                <tr>
                    ...
                    <td>{{$student->c_discount}}</td>
                    <td>{{$student->c_borrow}}</td>
                    <td>{{$student->c_date}}</td>

                    <td>
                            <button onclick="setvale({{ $student->c_borrow}} , {{$student->st_id}} , {{ $student->c_payment }} )" data-toggle="modal" data-target="#pay"
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content" style="margin-top: 20%;">
            ...
            <div class="modal-body">
                <form method="post" id="frm"  action="{{ route("barrowclass") }} " name="payment_form">
                    {{csrf_field()}}
